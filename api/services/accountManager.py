...
def create_account(request):
    ...
    Args:
        request: A dictionary containing the email, account_type, and name.
    ...
    # This part is to be refined or removed later as it is an additional, unnecessary query to the database
    account_info = fetch_account_info({'account type': account_type, 'email': email, 'name': name})

    if account_info.get('in_use'):
